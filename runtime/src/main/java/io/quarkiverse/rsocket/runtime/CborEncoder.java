...
public class CborEncoder implements Encoder {

    private static CBORFactory factory = new CBORFactory(new JsonMapper());
    ...
    public Payload encode(Object obj) {
        if (obj instanceof Payload) {
            ...
            try (CBORGenerator generator = factory.createGenerator(stream)) {
